...
|------------------------------------------+-----------------+---------------------------------------+--------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Month 1**<br>Foundation                | **Week 1**      | C++ Basics                            | Master syntax, pointers, references, functions, classes                              |  *C++ Primer (5th Edition)*<br> Bilibili: “Heima C++ Full Course” (beginner-friendly)<br> CPPReference (essential documentation)                                              |
